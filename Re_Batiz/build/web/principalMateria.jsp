<%-- 
    Document   : principalMateria
    Created on : 23 nov. 2022, 21:57:24
    Author     : JorgeEsteban
--%>
        ...
        <div class="container-xxl" align="center">
            ...
            <% 
                try{
                    ...
                    String strQry = "select distinct p.*, q.*, r.Nom_Vend from Producto p, Producto_Vendedores q, Vendedores r where	 p.ID_Prod = q.ID_Prod and q.ID_Usr = r.ID_Usr order by Materia_Prod;";
                    ResultSet rs= null;
                    ...
                    <div class="col-sm-4 " style=" float: left">
                        <table class="table table-borderless w-auto" style="background-color: #F8F0F0; border-radius: 15px; ">
                            <tr style="text-align: center">
                                <td colspan="2" class="fs-3 fsw-bold" ><a type="button" class="btn fs-3 fsw-bold"  href="desplegarProd.jsp?IDProd=<%=IDProd%>"><%=rs.getString(2)%></a></td>
                            </tr>
                            <tr>
