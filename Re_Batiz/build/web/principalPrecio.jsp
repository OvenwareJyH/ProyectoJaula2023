<%-- 
    Document   : principalPrecio
    Created on : 23 nov. 2022, 21:57:38
    Author     : JorgeEsteban
--%>
        ...
        <div class="container-xxl" align="center">
            ...
            <% 
                try{
                    ...
                    String strQry = "select distinct p.*, q.*, r.Nom_Vend from Producto p, Producto_Vendedores q, Vendedores r where p.ID_Prod = q.ID_Prod and q.ID_Usr = r.ID_Usr order by Precio_Prod;";
                    ResultSet rs= null;
