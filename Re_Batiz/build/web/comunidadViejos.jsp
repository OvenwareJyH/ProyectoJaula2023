<%-- 
    Document   : comunidadViejos
    Created on : Nov 24, 2022, 8:01:07 AM
    Author     : alumno
--%>
        ...
        <div class="container-xxl" align="center">
            ...
            <% 
                try{
                    ...
                    String strQry = "select distinct p.*, q.*, r.Nom_Usr from Posts p, Post_Usuario q, Usuarios r where p.ID_Posts = q.ID_Posts and q.ID_Usr = r.ID_Usr order by Fecha_Post desc;";
                    ResultSet rs= null;
